import { BasicMessageRecord, BasicMessageRole, CredentialExchangeRecord, CredentialPreviewAttribute, CredentialState, CredentialRole, ProofExchangeRecord, ProofState, ProofRole, ConnectionRecord, DidExchangeRole, DidExchangeState, OutOfBandRecord, OutOfBandInvitation, OutOfBandRole, OutOfBandState, OutOfBandDidCommService, Attachment, AgentMessage, } from '@credo-ts/core';
    ...
    outOfBandInvitation: new OutOfBandInvitation({
        ...
        appendedAttachments: [
            new Attachment({
                ...
                data: {
                    base64: '',
                },
            }),
        ],
    }),
...
const useBasicMessagesByConnectionId = jest.fn().mockReturnValue([]);
...
const useCredentialById = jest.fn().mockImplementation((id) => {
    return mockCredentialModule.credentials.find((cred) => cred.id === id);
});
const useProofById = jest.fn().mockImplementation((id) => {
...
const useCredentials = jest.fn().mockReturnValue({ records: [] });
const useProofs = jest.fn().mockReturnValue({ records: [] });
const useCredentialByState = jest.fn().mockImplementation((state) => {
    return useMemo(() => mockCredentialModule.credentials.filter((cred) => cred.state === state), [state]);
});
export { useAgent, useBasicMessages, useBasicMessagesByConnectionId, useConnectionById, useConnections, useCredentialById, useCredentialByState, useProofByState, useCredentials, useProofById, useProofs, };
