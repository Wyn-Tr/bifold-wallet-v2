...
import VerifierCredentialCard from '../../src/components/misc/VerifierCredentialCard';
...
describe('VerifierCredentialCard Component', () => {
    test('Renders correctly', async () => {
        ...
        <VerifierCredentialCard schemaId={'4eCXHS79ykiMv2PoBxPK23:2:unverified_person:0.1.0'} onChangeValue={jest.fn()} displayItems={displayItems} elevated/>
      </BasicAppContext>);
        await act(async () => { });
