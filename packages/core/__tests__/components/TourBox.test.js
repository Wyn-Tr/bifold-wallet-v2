...
describe('TourBox Component', () => {
    test('Renders properly with defaults', () => {
        ...
        <TourBox title={'Title'} leftText={'Left'} rightText={'Right'} onLeft={previous} onRight={next} currentTour={BaseTourID.HomeTour} currentStep={0} previous={previous} stop={stop} next={next}/>
      </TourProvider>);
