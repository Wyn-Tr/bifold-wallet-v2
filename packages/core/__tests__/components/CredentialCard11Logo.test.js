...
describe('CredentialCard11Logo', () => {
    ...
    test('Renders correctly', async () => {
        ...
        <CredentialCard11Logo noLogoText="Credential" overlay={{}}/>
      </BasicAppContext>);
    ...
    test('renders logo image when overlay has logo', () => {
        ...
        const tree = render(<BasicAppContext>
        <CredentialCard11Logo noLogoText="Credential" overlay={overlay}/>
      </BasicAppContext>);
    ...
    test('renders noLogoText when overlay has no logo', () => {
        ...
        const tree = render(<BasicAppContext>
        <CredentialCard11Logo noLogoText="Credential" overlay={overlay} elevated={true}/>
      </BasicAppContext>);
