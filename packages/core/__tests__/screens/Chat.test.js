import { BasicMessageRecord, BasicMessageRole, ConnectionRecord, DidExchangeRole, DidExchangeState, } from '@credo-ts/core';
...
const testBasicMessages = [unseenMessage, seenMessage];
describe('Chat Screen', () => {
    ...
    test('Renders correctly', async () => {
        ...
        const element = (<BasicAppContext>
        <Chat navigation={navigationContext} route={props}/>
      </BasicAppContext>);
