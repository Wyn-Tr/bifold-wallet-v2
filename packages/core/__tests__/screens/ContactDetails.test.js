...
describe('ContactDetails Screen', () => {
    ...
    test('Renders correctly', async () => {
        ...
        <StoreContext.Provider value={[
          ...
          <ContactDetails navigation={useNavigation()} route={{ params: { connectionId: connection.id } }}/>
    ...
    test('Edit contact name button navigates', async () => {
        ...
        <StoreContext.Provider value={[
          ...
          <ContactDetails navigation={navigation} route={{ params: { connectionId: connection.id } }}/>
        </StoreContext.Provider>
      </BasicAppContext>);
