...
describe('PINCreate Screen', () => {
    test('PIN create renders correctly', async () => {
        ...
        <StoreProvider initialState={{
          ...
          <AuthContext.Provider value={authContext}>
            <PINCreate route={{}} navigation={jest.fn()} setAuthenticated={jest.fn()} explainedStatus={true}/>
    ...
    test('PIN Explainer pops up correctly', async () => {
        ...
        <StoreProvider initialState={{
          ...
          <AuthContext.Provider value={authContext}>
            <PINCreate route={{}} navigation={jest.fn()} setAuthenticated={jest.fn()} explainedStatus={false}/>
          </AuthContext.Provider>
        </StoreProvider>
      </ContainerProvider>);
        // Causes RangeError: Invalid string length
