...
export const carousel = createCarouselStyle(OnboardingTheme);
const pages = [
    <>
...
describe('Onboarding Screen', () => {
    ...
    test('Pages exist', async () => {
        const { findAllByTestId } = render(<Onboarding pages={pages} nextButtonText="Next" previousButtonText="Back" style={carousel}/>);
