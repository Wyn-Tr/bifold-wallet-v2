...
import { ConnectionRecord, DidExchangeRole, DidExchangeState, OutOfBandInvitation, ProofExchangeRecord, ProofRole, ProofState, } from '@credo-ts/core';
...
describe('ProofRequesting Component', () => {
    ...
    const renderView = (params) => {
        ...
        <ProofRequesting navigation={testUseNavigation()} route={{ params }}/>
      </BasicAppContext>);
    };
