...
const CustomPages = (onTutorialCompleted, OnboardingTheme) => {
    ...
    return (<>
      ...
      <View style={{ marginTop: 'auto', margin: 20 }}>
        <Button title={t('Global.GetStarted')} accessibilityLabel={t('Global.GetStarted')} testID={testIdWithKey('GetStarted')} onPress={onTutorialCompleted} buttonType={ButtonType.Primary}/>
      </View>
    </>);
};
const guides = [
