...
const ScanHelp = () => {
    ...
    return (<SafeAreaView style={style.safeArea} edges={['top', 'left', 'right', 'bottom']}>
      <ScrollView contentContainerStyle={style.scrollView}>
        ...
        {whereToUseWalletUrl && (<Link linkText={t('Scan.WhereToUseLink')} style={style.text} onPress={() => Linking.openURL(whereToUseWalletUrl)} testID={testIdWithKey('WhereToUseLink')}/>)}
