...
const Developer = () => {
    ...
    return (<SafeAreaView style={{ flex: 1 }} edges={['bottom', 'left', 'right']}>
      <ScrollView style={styles.container}>
        ...
        <DeveloperToggleRow label={t('Verifier.UseVerifierCapability')} value={useVerifierCapability} onToggle={toggleVerifierCapabilitySwitch} accessibilityLabel={t('Verifier.Toggle')} pressableTestId={testIdWithKey('ToggleVerifierCapability')} switchTestId={testIdWithKey('VerifierCapabilitySwitchElement')}/>

        <DeveloperToggleRow label={t('Verifier.AcceptDevCredentials')} value={acceptDevCredentials} onToggle={toggleAcceptDevCredentialsSwitch} accessibilityLabel={t('Verifier.Toggle')} pressableTestId={testIdWithKey('ToggleAcceptDevCredentials')} switchTestId={testIdWithKey('AcceptDevCredentialsSwitchElement')}/>

        <DeveloperToggleRow label={t('Connection.UseConnectionInviterCapability')} value={useConnectionInviterCapability} onToggle={toggleConnectionInviterCapabilitySwitch} accessibilityLabel={t('Connection.Toggle')} pressableTestId={testIdWithKey('ToggleConnectionInviterCapabilitySwitch')} switchTestId={testIdWithKey('ConnectionInviterCapabilitySwitchElement')}/>

        <DeveloperToggleRow label={t('Verifier.UseDevVerifierTemplates')} value={useDevVerifierTemplates} onToggle={toggleDevVerifierTemplatesSwitch} accessibilityLabel={t('Verifier.ToggleDevTemplates')} pressableTestId={testIdWithKey('ToggleDevVerifierTemplatesSwitch')} switchTestId={testIdWithKey('DevVerifierTemplatesSwitchElement')}/>

        {!store.onboarding.didCreatePIN && (<DeveloperToggleRow label={t('NameWallet.EnableWalletNaming')} value={enableWalletNaming} onToggle={toggleWalletNamingSwitch} accessibilityLabel={t('NameWallet.ToggleWalletNaming')} pressableTestId={testIdWithKey('ToggleEnableWalletNamingSwitch')} switchTestId={testIdWithKey('EnableWalletNamingSwitchElement')}/>)}

        <DeveloperToggleRow label={t('Settings.PreventAutoLock')} value={preventAutoLock} onToggle={togglePreventAutoLockSwitch} accessibilityLabel={t('Settings.TogglePreventAutoLock')} pressableTestId={testIdWithKey('TogglePreventAutoLockSwitch')} switchTestId={testIdWithKey('PreventAutoLockSwitchElement')}/>

        <DeveloperToggleRow label={t('PasteUrl.UseShareableLink')} value={enableShareableLink} onToggle={toggleShareableLinkSwitch} accessibilityLabel={t('PasteUrl.UseShareableLink')} pressableTestId={testIdWithKey('ToggleUseShareableLink')} switchTestId={testIdWithKey('ShareableLinkSwitchElement')}/>

        <DeveloperToggleRow label={t('Settings.GenericErrorMessages')} value={enableGenericErrorMessages} onToggle={toggleGenericErrorMessages} accessibilityLabel={t('Settings.GenericErrorMessages')} pressableTestId={testIdWithKey('ToggleUseGenericErrorMessages')} switchTestId={testIdWithKey('GenericErrorMessagesSwitchElement')}/>

        <View style={styles.settingContainer}>
          <View style={{ flex: 1 }}>
            <Button title={t('Global.RefreshCredentials')} accessibilityLabel={t('Global.RefreshCredentials')} testID={testIdWithKey('Refresh Credentials')} onPress={onRunRefreshCycleTouched} buttonType={ButtonType.ModalPrimary}/>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>);
