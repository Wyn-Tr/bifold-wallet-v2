...
const MobileVerifierLoading = ({ navigation, route }) => {
    ...
    return (<SafeAreaModal transparent animationType={'slide'}>
      <SafeAreaView style={{ backgroundColor: ColorPalette.brand.modalPrimaryBackground }}>
        <ScrollView style={styles.container}>
          <View style={styles.messageContainer}>
            <ThemedText variant="modalHeadingThree" style={styles.messageText} testID={testIdWithKey('VerifierLoading')}>
        ...
        <View style={styles.controlsContainer}>
          <Button title={t('Global.GoBack')} accessibilityLabel={t('Global.GoBack')} testID={testIdWithKey('BackToProofList')} onPress={onDismissModalTouched} buttonType={ButtonType.ModalSecondary}/>
        </View>
      </SafeAreaView>
    </SafeAreaModal>);
};
