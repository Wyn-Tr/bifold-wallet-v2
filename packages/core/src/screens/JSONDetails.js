    ...
    return (<SafeAreaView style={styles.container} edges={['bottom', 'left', 'right']}>
      <View>
        ...
        <View style={styles.buttonContainer}>
          <Button title={t('JSONDetails.Share')} buttonType={ButtonType.Primary} testID={testIdWithKey('Share')} accessibilityLabel={t('JSONDetails.Share')} onPress={() => {
            shareJSON();
        }}></Button>
        </View>
        <View style={styles.buttonContainer}>
          <Button title={t('JSONDetails.Copy')} buttonType={ButtonType.Secondary} testID={testIdWithKey('CopyToClipboard')} accessibilityLabel={t('JSONDetails.Copy')} onPress={() => {
            copyToClipboard();
        }}></Button>
        </View>
      </View>
