        ...
        <View style={styles.screenContainer}>
          {hasNotificationsDisabled ? (<>
              ...
              <View style={styles.controlsContainer}>
                <Button buttonType={ButtonType.Primary} title={t('PushNotifications.OpenSettings')} accessibilityLabel={t('PushNotifications.OpenSettings')} testID={testIdWithKey('PushNotificationSettings')} onPress={() => Linking.openSettings()}/>
              </View>
            </>) : (<>
              <PushNotificationsContent />
              <View style={styles.toggleContainer}>
                <ThemedText>{t('PushNotifications.ReceiveNotifications')}</ThemedText>
                <Switch trackColor={{ false: ColorPalette.grayscale.lightGrey, true: ColorPalette.brand.primaryDisabled }} thumbColor={notificationState ? ColorPalette.brand.primary : ColorPalette.grayscale.mediumGrey} ios_backgroundColor={ColorPalette.grayscale.lightGrey} onValueChange={toggleSwitch} accessibilityLabel={t('PushNotifications.ReceiveNotifications')} accessibilityRole="switch" testID={testIdWithKey('PushNotificationSwitch')} value={notificationState}/>
              </View>
            </>)}
        </View>
      </ScrollView>
