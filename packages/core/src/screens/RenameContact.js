      ...
      <View style={styles.screenContainer}>
        <View style={styles.contentContainer}>
          ...
          <View style={{ width: '100%' }}>
            <LimitedTextInput defaultValue={contactName} label={t('RenameContact.ContactName')} limit={50} handleChangeText={handleChangeText} accessibilityLabel={t('RenameContact.ContactName')} testID={testIdWithKey('NameInput')}/>
          </View>
        </View>
        <View style={styles.controlsContainer}>
          <View style={styles.buttonContainer}>
            <Button title={t('Global.Save')} buttonType={ButtonType.Primary} testID={testIdWithKey('Save')} accessibilityLabel={t('Global.Save')} onPress={handleContinuePressed} disabled={loading}>
              {loading && <ButtonLoading />}
            </Button>
            <View style={{ marginTop: 15 }}>
              <Button title={t('Global.Cancel')} buttonType={ButtonType.Secondary} testID={testIdWithKey('Cancel')} accessibilityLabel={t('Global.Cancel')} onPress={handleCancelPressed}/>
            </View>
          </View>
        </View>
      </View>
