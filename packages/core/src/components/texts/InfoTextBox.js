...
const iconSize = 30;
const offset = 10;
const InfoTextBox = ({ children, type = InfoBoxType.Info, iconVerticalPosition = 'high', iconHorizontalPosition = 'left', style = {}, textStyle = {}, }) => {
    ...
    return (<View style={styles.container}>
      <View style={styles.row}>
        ...
        {typeof children === 'string' ? (<ThemedText variant="bold" style={styles.text}>
            {children}
          </ThemedText>) : (<>{children}</>)}
      </View>
    </View>);
