...
const FauxHeader = ({ title, onBackPressed = () => { }, showBackButton = true }) => {
    ...
    return (<View style={styles.header}>
      <View style={styles.left}>
        {showBackButton && (<IconButton buttonLocation={ButtonLocation.Left} accessibilityLabel={t('Global.Back')} testID={testIdWithKey('BackButton')} onPress={onBackPressed} icon="chevron-left"/>)}
      </View>
