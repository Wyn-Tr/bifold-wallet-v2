...
const ButtonImplComponent = ({ title, buttonType, accessibilityLabel, accessibilityHint, testID, onPress, disabled = false, maxfontSizeMultiplier, children, }, ref) => {
    ...
    return (<TouchableOpacity onPress={onPress} accessible accessibilityLabel={accessibilityLabel} accessibilityHint={accessibilityHint} accessibilityRole={'button'} onPressIn={() => setIsActive(!disabled && true)} onPressOut={() => setIsActive(false)} testID={testID} style={[
        ...
        ]} disabled={disabled} activeOpacity={heavyOpacity} ref={ref}>
      <View style={{
            flexDirection: 'row',
        ...
        {children}
        <ThemedText maxFontSizeMultiplier={maxfontSizeMultiplier} style={[
...
const ButtonImpl = forwardRef(ButtonImplComponent);
