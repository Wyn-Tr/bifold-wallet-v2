...
export var ButtonLocation;
(function (ButtonLocation) {
    ButtonLocation[ButtonLocation["Left"] = 0] = "Left";
    ButtonLocation[ButtonLocation["Right"] = 1] = "Right";
})(ButtonLocation || (ButtonLocation = {}));
const IconButton = ({ buttonLocation, icon, text, accessibilityLabel, testID, onPress, iconTintColor, }) => {
    ...
    const myText = () => text ? (<ThemedText maxFontSizeMultiplier={1} variant="label" style={style.title}>
        {text}
      </ThemedText>) : null;
    ...
    return (<Pressable accessibilityLabel={accessibilityLabel} accessibilityRole={'button'} testID={testID} onPress={onPress} hitSlop={hitSlop}>
