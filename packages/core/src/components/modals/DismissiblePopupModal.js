...
const DismissiblePopupModal = ({ title, description, onCallToActionPressed, onCallToActionLabel, onDismissPressed, }) => {
          ...
          <TouchableWithoutFeedback accessible={false}>
            <View style={styles.container}>
              ...
              <View style={styles.bodyContainer}>
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollViewContentContainer} style={styles.scrollViewStyle}>
                ...
                {onCallToActionPressed && (<View style={styles.footer}>
                    <Button title={onCallToActionLabel || t('Global.Okay')} accessibilityLabel={onCallToActionLabel || t('Global.Okay')} testID={testIdWithKey('Okay')} buttonType={ButtonType.ModalPrimary} onPress={onCallToActionPressed}/>
                  </View>)}
              </View>
            </View>
