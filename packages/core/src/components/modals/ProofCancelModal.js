...
const ProofCancelModal = ({ visible, onDone }) => {
    ...
    return (<SafeAreaModal visible={visible} animationType="slide">
      <SafeAreaView style={styles.safeAreaView}>
        ...
        <View style={styles.controlsContainer}>
          <View style={{ paddingTop: 10 }}>
            <Button title={t('Global.Done')} accessibilityLabel={t('Global.Done')} testID={testIdWithKey('Done')} onPress={onDone} buttonType={ButtonType.ModalPrimary}/>
          </View>
        </View>
      </SafeAreaView>
    </SafeAreaModal>);
