...
const FullScreenErrorModal = ({ errorTitle = '', errorDescription = '', visible = false, onPressCTA = () => { }, }) => {
    ...
    return (<SafeAreaModal style={{ backgroundColor: ColorPalette.brand.primaryBackground }} visible={visible} transparent={false} animationType={'none'} presentationStyle={'fullScreen'} statusBarTranslucent={true}>
      ...
      <View style={style.container}>
        <InfoBox title={showGenericErrorMessage ? t('Error.GenericError.Title') : errorTitle} message={showGenericErrorMessage ? t('Error.GenericError.Message') : errorDescription} notificationType={InfoBoxType.Error} renderShowDetails/>
