 ...
 */
const KeyboardView = ({ children, scrollViewProps }) => {
    const safeHeaderHeight = useSafeHeaderHeight();
    return (<KeyboardAvoidingView style={{ flex: 1 }} keyboardVerticalOffset={safeHeaderHeight} behavior="padding">
      <KeyboardAwareScrollView keyboardShouldPersistTaps={'handled'} contentContainerStyle={[{ flexGrow: 1 }, scrollViewProps?.contentContainerStyle]} showsVerticalScrollIndicator={false} {...scrollViewProps}>
        {children}
