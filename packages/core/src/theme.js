 ...
 */
export function createTextTheme(theme) {
 ...
 */
export function createButtonsTheme(theme) {
 ...
 */
export function createListItemsTheme(theme) {
 ...
 */
export function createTabTheme(theme) {
    const textStyles = StyleSheet.create({
        tabBarTextStyle: {
 ...
 */
export function createHomeTheme(theme) {
    return StyleSheet.create({
        welcomeHeader: {
            ...theme.TextTheme.headingOne,
        },
 ...
 */
export function createSettingsTheme(theme) {
 ...
 */
export function createChatTheme(theme) {
    const textStyles = StyleSheet.create({
        timeStyleLeft: {
 ...
 */
export function createOnboardingTheme(theme) {
    const textStyles = StyleSheet.create({
        pagerDot: {
            borderColor: theme.ColorPalette.brand.primary,
        },
 ...
 */
export function createDialogTheme(theme) {
    return StyleSheet.create({
        modalView: {
            backgroundColor: theme.ColorPalette.brand.secondaryBackground,
        },
...
export function createLoadingTheme(theme) {
    return {
        backgroundColor: theme.ColorPalette.brand.modalPrimaryBackground,
    };
}
 ...
 */
export function createPINInputTheme(theme) {
    const textStyles = StyleSheet.create({
        cellText: {
            color: theme.ColorPalette.brand.text,
        },
 ...
 */
export function createSeparatedPINInputTheme(theme) {
    const textStyles = StyleSheet.create({
        cellText: {
            color: theme.ColorPalette.brand.text,
        },
 ...
 */
export function createInputInlineMessageTheme(theme) {
    return {
...
export const themes = [bifoldTheme];
