...
const HistoryListItem = ({ item }) => {
        ...
        switch (item.content.type) {
            ...
            case HistoryCardType.CardDeclined: {
                return {
                    ...
                    title: (<ThemedText variant="headerTitle" style={{ color: styles.historyCardRevoked.color }}>
            ...
            case HistoryCardType.PinChanged: {
                return {
                    ...
                    title: (<ThemedText variant="headerTitle" style={{ color: styles.infoBox.color }}>
            ...
            case HistoryCardType.InformationSent: {
                return {
                    ...
                    title: (<ThemedText variant="headingThree" style={{ color: styles.successColor.color }}>
            ...
            case HistoryCardType.ConnectionRemoved: {
                return {
                    ...
                    title: (<ThemedText variant="headingThree" style={{ color: styles.historyCardRevoked.color }}>
    ...
    const renderCardDate = (date) => {
        ...
        return (<ThemedText style={styles.cardDate}>
