...
const HistoryPage = () => {
    ...
    return (<View style={style.screenContainer}>
      <View style={style.contentContainer}>
        <View>
          <Button title={t('History.SortFilterButton')} testID={actionButtonTestId} accessibilityLabel={actionButtonLabel} buttonType={ButtonType.Secondary} onPress={async () => {
            //TODO: Save settings
          ...
          <FlatList showsVerticalScrollIndicator={false} style={{ flexGrow: 0 }} data={historyItems} ListEmptyComponent={renderEmptyListComponent} renderItem={(element) => renderHistoryListItem(element.item)}/>
        </View>
      </View>
    </View>);
};
