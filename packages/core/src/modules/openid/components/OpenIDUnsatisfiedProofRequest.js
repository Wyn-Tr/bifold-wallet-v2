...
const OpenIDUnsatisfiedProofRequest = ({ verifierName, credentialName, requestPurpose }) => {
    ...
    return (<View style={styles.container}>
      <InfoBox title={t('UnsatisfiedProofRequest.InfoBox.Title')} message={t('UnsatisfiedProofRequest.InfoBox.Subtitle', { verifierName })} notificationType={InfoBoxType.Error} renderShowDetails/>
