...
export function OpenIDCredentialRowCard({ name, issuer, bgColor, bgImage, txtColor, onPress }) {
    ...
    return (<View style={style.container}>
      <TouchableOpacity onPress={onPress} style={style.rowContainer} accessibilityLabel={name} accessibilityRole="button">
