...
export var OpenIDCredScreenMode;
(function (OpenIDCredScreenMode) {
    OpenIDCredScreenMode[OpenIDCredScreenMode["offer"] = 0] = "offer";
    OpenIDCredScreenMode[OpenIDCredScreenMode["details"] = 1] = "details";
})(OpenIDCredScreenMode || (OpenIDCredScreenMode = {}));
const paddingHorizontal = 24;
const paddingVertical = 16;
const OpenIDCredentialDetails = ({ navigation, route }) => {
    ...
    return (<ScreenLayout screen={Screens.OpenIDCredentialDetails}>
      ...
      <CommonRemoveModal usage={ModalUsage.CredentialRemove} visible={isRemoveModalDisplayed} onSubmit={handleDeclineTouched} onCancel={toggleDeclineModalVisible}/>
    </ScreenLayout>);
};
