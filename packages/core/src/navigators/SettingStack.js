...
const SettingStack = () => {
    ...
    const [pages, { screen: terms }, ToggleBiometry, developer, ScreenOptionsDictionary, Onboarding, 
    // New injectable screens
    Settings, RenameWallet, Language, ConfigureMediator, AutoLock, DataRetention, Tours, PINChange, PINChangeSuccessScreen, TogglePushNotifications, HistorySettings, 
    // Wallet Backup/Restore Screens
    ExportWalletIntro, ExportWallet, ImportWallet, ImportWalletScan, ImportWalletResult,] = useServices([
    ...
    return (<Stack.Navigator screenOptions={{ ...defaultStackOptions }}>
      <Stack.Screen name={Screens.Settings} component={Settings} options={{
      ...
      <Stack.Screen name={Screens.Language} component={Language} options={{
            title: t('Screens.Language'),
            headerBackTestID: testIdWithKey('Back'),
            ...ScreenOptionsDictionary[Screens.Language],
        }}/>
      <Stack.Screen name={Screens.ConfigureMediator} component={ConfigureMediator} options={{
            title: 'Configure Mediator',
            headerBackTestID: testIdWithKey('Back'),
            ...ScreenOptionsDictionary[Screens.ConfigureMediator],
        }}/>
      <Stack.Screen name={Screens.AutoLock} component={AutoLock} options={{
            title: 'Auto lock Options',
            headerBackTestID: testIdWithKey('Back'),
            ...ScreenOptionsDictionary[Screens.AutoLock],
        }}/>
      <Stack.Screen name={Screens.DataRetention} component={DataRetention} options={{
            title: t('Screens.DataRetention'),
            headerBackTestID: testIdWithKey('Back'),
            ...ScreenOptionsDictionary[Screens.DataRetention],
        }}/>
      <Stack.Screen name={Screens.Tours} component={Tours} options={{
            title: t('Screens.Tours'),
            headerBackTestID: testIdWithKey('Back'),
            ...ScreenOptionsDictionary[Screens.Tours],
        }}/>
      <Stack.Screen name={Screens.ToggleBiometry} component={ToggleBiometry} options={{
            title: t('Screens.Biometry'),
            headerBackTestID: testIdWithKey('Back'),
            ...ScreenOptionsDictionary[Screens.ToggleBiometry],
        }}/>
      <Stack.Screen name={Screens.ChangePIN} component={PINChange} options={{
            title: t('Screens.ChangePIN'),
            headerBackTestID: testIdWithKey('Back'),
            ...ScreenOptionsDictionary[Screens.ChangePIN],
        }}/>
      <Stack.Screen name={Screens.ChangePINSuccess} component={PINChangeSuccessScreen} options={{
            title: t('Screens.ConfirmPIN'),
            headerBackTestID: testIdWithKey('Back'),
            headerLeft: () => null,
            ...ScreenOptionsDictionary[Screens.ChangePINSuccess],
        }}/>
      <Stack.Screen name={Screens.TogglePushNotifications} component={TogglePushNotifications} options={{
            title: t('Screens.PushNotifications'),
            headerBackTestID: testIdWithKey('Back'),
            ...ScreenOptionsDictionary[Screens.TogglePushNotifications],
        }}/>
      <Stack.Screen name={Screens.Terms} component={terms} options={{
            title: t('Screens.Terms'),
            headerBackTestID: testIdWithKey('Back'),
            ...ScreenOptionsDictionary[Screens.Terms],
        }}/>
      <Stack.Screen name={Screens.Developer} component={developer} options={{
      ...
      <Stack.Screen name={Screens.Onboarding} options={{ title: t('Screens.Onboarding') }}>
        {(props) => (<Onboarding {...props} nextButtonText={t('Global.Next')} previousButtonText={t('Global.Back')} pages={pages(() => null, OnboardingTheme)} style={carousel} disableSkip={true}/>)}
      </Stack.Screen>
      <Stack.Screen name={Screens.HistorySettings} component={HistorySettings} options={{
            title: t('Screens.HistorySettings'),
            headerBackTestID: testIdWithKey('Back'),
            ...ScreenOptionsDictionary[Screens.HistorySettings],
        }}/>
      <Stack.Screen name={Screens.ExportWalletIntro} component={ExportWalletIntro} options={{
            title: t('ExportWallet.TransferWallet'),
            headerBackTestID: testIdWithKey('Back'),
        }}/>
      <Stack.Screen name={Screens.ExportWallet} component={ExportWallet} options={{
            title: t('ExportWallet.TransferWallet'),
            headerBackTestID: testIdWithKey('Back'),
        }}/>
      <Stack.Screen name={Screens.ImportWallet} component={ImportWallet} options={{
            title: t('ImportWallet.RestoreWallet'),
            headerBackTestID: testIdWithKey('Back'),
        }}/>
      <Stack.Screen name={Screens.ImportWalletScan} component={ImportWalletScan} options={{
            title: t('ImportWallet.ScanQRCode'),
            headerBackTestID: testIdWithKey('Back'),
        }}/>
      <Stack.Screen name={Screens.ImportWalletResult} component={ImportWalletResult} options={{
            title: '',
            headerBackTestID: testIdWithKey('Back'),
            headerLeft: () => null,
        }}/>
