...
import { AutoAcceptCredential, AutoAcceptProof, BasicMessagesModule, ConnectionsModule, CredentialsModule, DidsModule, DifPresentationExchangeProofFormatService, JwkDidResolver, KeyDidResolver, MediationRecipientModule, MediatorPickupStrategy, PeerDidResolver, ProofsModule, V2CredentialProtocol, V2ProofProtocol, WebDidResolver, } from '@credo-ts/core';
 ...
 */
export function getAgentModules({ indyNetworks, mediatorInvitationUrl, txnCache, webrtcIceServers }) {
