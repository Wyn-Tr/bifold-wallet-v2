...
const useCredentialCardStyles = (overlay, brandingOverlayType, proof) => {
    ...
    const styles = StyleSheet.create({
        ...
        primaryBodyContainer: {
            ...
            marginLeft: brandingOverlayType === BrandingOverlayType.Branding10
        ...
        textContainer: {
            color: proof && brandingOverlayType === BrandingOverlayType.Branding10
